function [early_exocytosis, late_exocytosis, total_exocytosis, v_half, vh_r2, peak_INa, v_half_act, vha_r2, peak_ICa, late_ICa, ramp_IK, Peak_IK_minus20, Peak_IK_max, v_half_act_IK, n_act_IK]... , v_half_IK_inact], tau1_IK_inact, tau2_IK_inact, Amp1_IK_inact, Amp2_IK_inact]...
    = run_v_clamp(parameters, parameter_names, states, state_names, rhs_model)
...
% Run all the voltage clamp modules
    ...
    [Peak_IK_minus20, Peak_IK_max] = HerringtonK_square(parameters, parameter_names, states, state_names, rhs_model);
    [v_half_act_IK, n_act_IK] = HerringtonK_tail_1(parameters, parameter_names, states, state_names, rhs_model);
